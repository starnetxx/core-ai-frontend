        ...
        <div className="flex flex-col lg:flex-row items-center gap-12 lg:gap-24">
          <div className="flex-1 max-w-xl w-full">
            <h2 className="text-2xl md:text-4xl font-bold tracking-tight text-slate-900 mb-6 md:mb-8 leading-tight">
              <span className="block mb-4">Instead of treating objects as ephemeral predictions,</span>
              <span className="block">CORE maintains stateful object representations that evolve as new images, prompts, and relationships are observed.</span>
            </h2>
